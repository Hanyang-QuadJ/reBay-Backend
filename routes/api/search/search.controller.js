...
exports.searchByPriceA = (req, res) => {
    ...
    sql += `price >= ${min_price} and price <= ${max_price} ORDER BY Items.price ASC LIMIT 10 OFFSET ${index};`
    conn.query(
        sql,
        (err, result) => {
            if (err) throw err;
...
exports.searchByPriceD = (req, res) => {
    ...
    sql += `price >= ${min_price} and price <= ${max_price} ORDER BY Items.price DESC LIMIT 10 OFFSET ${index};`
    conn.query(
        sql,
        (err, result) => {
            if (err) throw err;
...
exports.searchByDateA = (req, res) => {
    ...
    sql += `price >= ${min_price} and price <= ${max_price} ORDER BY Items.time ASC LIMIT 10 OFFSET ${index};`
    conn.query(
        sql,
        (err, result) => {
            if (err) throw err;
...
exports.searchByDateD = (req, res) => {
    ...
    sql += `price >= ${min_price} and price <= ${max_price} ORDER BY Items.time DESC LIMIT 10 OFFSET ${index};`
    conn.query(
        sql,
        (err, result) => {
            if (err) throw err;
